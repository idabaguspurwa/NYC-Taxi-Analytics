...
FROM
    OPENROWSET(
        BULK 'https://synapsedatalakes.dfs.core.windows.net/nyc-taxi-data/raw/taxi_zone.csv',
        FORMAT = 'CSV',
        PARSER_VERSION = '2.0'
    ) AS [result]
...
FROM
    OPENROWSET(
        BULK 'abfss://nyc-taxi-data@synapsedatalakes.dfs.core.windows.net/raw/taxi_zone_without_header.csv',
        FORMAT = 'CSV',
        PARSER_VERSION = '2.0',
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '\n'
...
WITH (
    LOCATION = 'abfss://nyc-taxi-data@synapsedatalakes.dfs.core.windows.net/'
)

CREATE EXTERNAL DATA SOURCE nyc_taxi_data_raw
WITH (
    LOCATION = 'abfss://nyc-taxi-data@synapsedatalakes.dfs.core.windows.net/raw'
)
